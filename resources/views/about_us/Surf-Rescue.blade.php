...
<div class="container flex justify-center max-w-full flex-wrap">
    <main class="Surf-Rescue flex-warp flex-col flex mt-20">
            ...
            <div class="content-right">
                <div class="right-box w-full flex flex-wrap gap-6">
                    <div class="top flex w-full">
                        <div class="sport-bg flex items-center p-6 mr-6 ">
        ...
        <div class="qualifying flex mt-20 ">
            <div class="qualifying-left">
                <div class="Surf-Rescue-title flex flex-wrap">
                    <div class="color-line flex">
                        <div class="blue1"></div>
                        <div class="blue2"></div>

...
@section('main')
    <main id="main" class="flex flex-col-reverse md:flex-row w-full md:h-screen ">
                                ...
                                <div class="tab w-full">
                                    ...
                                    <div class="tab-content" id="s1-tabs-tabContent">
                                        <div class="tabs-1 tab-pane fade show active flex flex-col" id="s1-tabs-1"
                                            role="tabpanel" aria-labelledby="tabs-1-tab">
                                            <div class="intro">
        ...
        <!------------------------------ s4 ---------------------------------->
        <section id="modal04" tabindex="-1" aria-hidden="true"
            class="section hidden overflow-y-auto overflow-x-hidden bg-white flex flex-col justify-between items-center">
                                ...
                                <div class="tab w-full">
                                    <ul class="nav nav-tabs flex flex-row flex-wrap list-none border-b-0 items-center"
                                        ...
                                        <li class="nav-item">
                                            ...
                                            focus:border-transparent
                                        "
                                                id="s4-tabs-2-tab" data-bs-toggle="pill" data-bs-target="#s4-tabs-2"
                                                role="tab" aria-controls="s4-tabs-2" aria-selected="false">
                                                <span class="tab-span tab-span2">課程流程</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            focus:border-transparent
                                        "
                                                id="s4-tabs-3-tab" data-bs-toggle="pill" data-bs-target="#s4-tabs-3"
                                                role="tab" aria-controls="s4-tabs-3" aria-selected="false">
                                                <span class="tab-span tab-span3">指導單位</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            focus:border-transparent
                                        "
                                                id="s4-tabs-4-tab" data-bs-toggle="pill" data-bs-target="#s4-tabs-4"
                                                role="tab" aria-controls="s4-tabs-4" aria-selected="false">
                                                <span class="tab-span tab-span4">注意事項</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="s4-tabs-tabContent">
                                        <div class="tabs-1 tab-pane fade show active flex flex-col" id="s4-tabs-1"
                                            role="tabpanel" aria-labelledby="s4-tabs-1-tab">
                                            <div class="intro">
                                                <h3 class="h3m">潛水</h3>
                                        ...
                                        <div class="tabs-2 tab-pane fade flex flex-col" id="s4-tabs-2" role="tabpanel"
                                            aria-labelledby="s4-tabs-2-tab">
                                            <div class="flex flex-col day1">
                                                <h3>第一天</h3>
                                                <div class="flex flex-col">
                                                    <div class="flex day-time-title day-time">
                                        ...
                                        <div class="tabs-3 tab-pane fade flex flex-col" id="s4-tabs-3" role="tabpanel"
                                            aria-labelledby="s4-tabs-3-tab">
                                            <div class="flex flex-col box">
                                                <h3 class="h3m">指導單位</h3>
                                                <p class="tm">主辦單位：台中市水中運動協會,SUP風浪板/獨木舟委員會</p>
                                                <p class="tm">協辦單位: 日月磐石水上活動中心</p>
                                        ...
                                        <div class="tabs-4 tab-pane fade flex flex-col" id="s4-tabs-4" role="tabpanel"
                                            aria-labelledby="s4-tabs-4-tab">
                                            <div class="flex flex-col box">
                                                <h3 class="h3m">注意事項</h3>
                                                <p class="tm">活動含保險、器材、救生衣，繳交後非本會或天然災害因素恕不退還。</p>
                                                <p class="tm">報名電話：水中運動協會報名專線 04-22312698 台中市總教練 詹寓崵 0930975535
        ...
        <!------------------------------ s5 ---------------------------------->
        <section id="modal05" tabindex="-1" aria-hidden="true"
            class="section hidden overflow-y-auto overflow-x-hidden bg-white flex flex-col justify-between items-center">
                                        ...
                                        <li class="nav-item">
                                            <a href="#s5-tabs-1"
                                                class="
                                                    ...
                                                    focus:border-transparent
                                                "
                                                id="s5-tabs-1-tab" data-bs-toggle="pill" data-bs-target="#s5-tabs-1"
                                                role="tab" aria-controls="s5-tabs-1" aria-selected="true">
                                                <span class="tab-span tab-span1">活動介紹</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#s5-tabs-2"
                                                class="
                                                    ...
                                                    focus:border-transparent
                                                "
                                                id="s5-tabs-2-tab" data-bs-toggle="pill" data-bs-target="#s5-tabs-2"
                                                role="tab" aria-controls="s5-tabs-2" aria-selected="false">
                                                <span class="tab-span tab-span2">課程流程</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#s5-tabs-3"
                                                class="
                                                    ...
                                                    focus:border-transparent
                                                "
                                                id="s5-tabs-3-tab" data-bs-toggle="pill" data-bs-target="#s5-tabs-3"
                                                role="tab" aria-controls="s5-tabs-3" aria-selected="false">
                                                <span class="tab-span tab-span3">指導單位</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#s5-tabs-4"
                                                class="
                                                    ...
                                                    focus:border-transparent
                                                "
                                                id="s5-tabs-4-tab" data-bs-toggle="pill" data-bs-target="#s5-tabs-4"
                                                role="tab" aria-controls="s5-tabs-4" aria-selected="false">
                                                <span class="tab-span tab-span4">注意事項</span>
                                            </a>
                                        </li>
                                    </ul>

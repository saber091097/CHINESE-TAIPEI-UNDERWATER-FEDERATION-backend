                            ...
                            <div class="tab w-full">
                                <ul class="nav nav-tabs flex flex-row flex-wrap list-none border-b-0 items-center" id="s1-tabs-tab"
                                    ...
                                    <li class="nav-item">
                                        ...
                                        " id="s1-tabs-1-tab" data-bs-toggle="pill" data-bs-target="#s1-tabs-1" role="tab" aria-controls="s1-tabs-1"
                                        aria-selected="true" tabindex="1">
                                        <span class="tab-span tab-span1">活動介紹</span>
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s1-tabs-2" class="
                                            nav-link
                                            nav-link2
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s1-tabs-2-tab" data-bs-toggle="pill" data-bs-target="#s1-tabs-2" role="tab"
                                            aria-controls="s1-tabs-2" aria-selected="false">
                                            <span class="tab-span tab-span2">課程流程</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s1-tabs-3" class="
                                            nav-link
                                            nav-link3
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s1-tabs-3-tab" data-bs-toggle="pill" data-bs-target="#s1-tabs-3" role="tab"
                                            aria-controls="s1-tabs-3" aria-selected="false">
                                            <span class="tab-span tab-span3">指導單位</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s1-tabs-4" class="
                                            nav-link
                                            nav-link4
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s1-tabs-4-tab" data-bs-toggle="pill" data-bs-target="#s1-tabs-4" role="tab"
                                            aria-controls="s1-tabs-4" aria-selected="false">
                                            <span class="tab-span tab-span4">注意事項</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="s1-tabs-tabContent">
                                    <div class="tabs-1 tab-pane fade show active flex flex-col" id="s1-tabs-1" role="tabpanel" aria-labelledby="tabs-1-tab">
                                        <div class="intro">
                                            <h3 class="h3m">水上救生</h3>
                                            <p class="tm">救生員：指經檢定合格，具備救生基礎知識及能力，擔任水域救生工作之體育專業人員。
                                                為推廣水上安全教育，提倡水上救生技術、培養義務救生員，減少水難為目的!</p>
                                        </div>
                                        <div class="purpor">
                                            <h3 class="h3m">活動主旨</h3>
                                            <p class="tm">SUP立式划槳教練課程，選修風浪板、獨木舟三合一Windsupyak板，
                                                推動水上運動觀光及帶動地方觀光和繁榮提升SUP風浪板/獨木舟運動風氣及培訓專業教練人才。
                                                 發展專利著作SUPTUF(中華民國立式划槳浪板訓練協會)教學系統認證。有品牌有信譽的標章SUPTUF已經榮獲中華民國經濟部智慧財產局註冊、認證。</p>
                                        </div>
                                        <div class="time">
                                        ...
                                        <div class="video">
                                            ...
                                            <div class="video-link">
                                                <iframe width="100%" height="420" src="https://www.youtube.com/embed/5PGKxWH2WYs"
                                    ...
                                    <div class="tabs-2 tab-pane fade flex flex-col" id="s1-tabs-2" role="tabpanel" aria-labelledby="tabs-2-tab">
                                    ...
                                    <div class="tabs-3 tab-pane fade flex flex-col" id="s1-tabs-3" role="tabpanel" aria-labelledby="tabs-3-tab">
                                    ...
                                    <div class="tabs-4 tab-pane fade flex flex-col" id="s1-tabs-4" role="tabpanel" aria-labelledby="tabs-4-tab">
                                        <div class="flex flex-col box">
                                            <h3 class="h3m">注意事項</h3>
                                            <p class="tm">活動含保險、器材、救生衣，繳交後非本會或天然災害因素恕不退還。</p>
                                            <p class="tm">報名電話：水中運動協會報名專線 04-22312698 台中市總教練 詹寓崵 0930975535</p>
                                        ...
                                        <div class="flex flex-col box">
                                            ...
                                            <p class="tm">選修:風浪板教練證,獨木舟教練證Windsupyak instructor等專長教練證,相關業務洽協會辦公室)。</p>
                                        </div>
                                        <div class="flex flex-col box">
                    ...
                    <div class="class-content w-full flex flex-row">
                        <div class="in-in-innerbox-right w-8/12 ">
                            <div class="banner w-full">
                                <div id="s2_mySwiper2" style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="/img/S__14082119.jpg" />
                                        </div>
                            ...
                            <div class="tab w-full">
                                <ul class="nav nav-tabs flex flex-row flex-wrap list-none border-b-0 items-center" id="s2-tabs-tab"
                                    role="tablist">
                                    <li class="nav-item">
                                        <a href="#s2-tabs-1" class="
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s2-tabs-1-tab" data-bs-toggle="pill" data-bs-target="#s2-tabs-1" role="tab" aria-controls="s2-tabs-1"
                                        aria-selected="true">
                                        <span class="tab-span tab-span1">活動介紹</span>
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s2-tabs-2" class="
                                            nav-link
                                            nav-link2
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s2-tabs-2-tab" data-bs-toggle="pill" data-bs-target="#s2-tabs-2" role="tab"
                                            aria-controls="s2-tabs-2" aria-selected="false">
                                            <span class="tab-span tab-span2">課程流程</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s2-tabs-3" class="
                                            nav-link
                                            nav-link3
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s2-tabs-3-tab" data-bs-toggle="pill" data-bs-target="#s2-tabs-3" role="tab"
                                            aria-controls="s2-tabs-3" aria-selected="false">
                                            <span class="tab-span tab-span3">指導單位</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s2-tabs-4" class="
                                            nav-link
                                            nav-link4
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s2-tabs-4-tab" data-bs-toggle="pill" data-bs-target="#s2-tabs-4" role="tab"
                                            aria-controls="s2-tabs-4" aria-selected="false">
                                            <span class="tab-span tab-span4">注意事項</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="s2-tabs-tabContent">
                                    <div class="tabs-1 tab-pane fade show active flex flex-col" id="s2-tabs-1" role="tabpanel" aria-labelledby="s2-tabs-1-tab">
                                        <div class="intro">
                                            <h3 class="h3m">游泳</h3>
                                            <p class="tm">游泳是在水中靠浮力，借自身肢體的動作在水中運動前進的運動和技能。游泳不僅是最佳的減肥運動，
                                                同時還能提升肺活量、增強抵抗力、保護膝蓋，可以說是CP值相當高的運動!</p>
                                        </div>
                                        <div class="purpor">
                                            <h3 class="h3m">活動主旨</h3>
                                            <p class="tm">SUP立式划槳教練課程，選修風浪板、獨木舟三合一Windsupyak板，
                                    ...
                                    <div class="tabs-2 tab-pane fade flex flex-col" id="s2-tabs-2" role="tabpanel" aria-labelledby="s2-tabs-2-tab">
                                        <div class="flex flex-col day1">
                                            <h3>第一天</h3>
                                            <div class="flex flex-col">
                                                <div class="flex day-time-title day-time">
                                    ...
                                    <div class="tabs-3 tab-pane fade flex flex-col" id="s2-tabs-3" role="tabpanel" aria-labelledby="s2-tabs-3-tab">
                                        <div class="flex flex-col box">
                                            <h3 class="h3m">指導單位</h3>
                                            <p class="tm">主辦單位：台中市水中運動協會,SUP風浪板/獨木舟委員會</p>
                                            <p class="tm">協辦單位: 日月磐石水上活動中心</p>
                                    ...
                                    <div class="tabs-4 tab-pane fade flex flex-col" id="s2-tabs-4" role="tabpanel" aria-labelledby="s2-tabs-4-tab">
                                        <div class="flex flex-col box">
                                            <h3 class="h3m">注意事項</h3>
                                            <p class="tm">活動含保險、器材、救生衣，繳交後非本會或天然災害因素恕不退還。</p>
                                            <p class="tm">報名電話：水中運動協會報名專線 04-22312698 台中市總教練 詹寓崵 0930975535</p>
            ...
            <div class="w-full h-full s3-innerbox s-innerbox flex flex-col items-center">
                ...
                <div class="s3-innerbox-btm s-innerbox-btm w-4/5 flex flex-col">
                    ...
                    <div class="class-content w-full flex flex-row">
                        <div class="in-in-innerbox-right w-8/12 ">
                            <div class="banner w-full">
                                <div id="s3_mySwiper2" style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="/img/S__14082119.jpg" />
                                        </div>
                            ...
                            <div class="tab w-full">
                                <ul class="nav nav-tabs flex flex-row flex-wrap list-none border-b-0 items-center" id="s3-tabs-tab"
                                    role="tablist">
                                    <li class="nav-item">
                                        <a href="#s3-tabs-1" class="
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s3-tabs-1-tab" data-bs-toggle="pill" data-bs-target="#s3-tabs-1" role="tab" aria-controls="s3-tabs-1"
                                        aria-selected="true">
                                        <span class="tab-span tab-span1">活動介紹</span>
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s3-tabs-2" class="
                                            nav-link
                                            nav-link2
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s3-tabs-2-tab" data-bs-toggle="pill" data-bs-target="#s3-tabs-2" role="tab"
                                            aria-controls="s3-tabs-2" aria-selected="false">
                                            <span class="tab-span tab-span2">課程流程</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s3-tabs-3" class="
                                            nav-link
                                            nav-link3
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s3-tabs-3-tab" data-bs-toggle="pill" data-bs-target="#s3-tabs-3" role="tab"
                                            aria-controls="s3-tabs-3" aria-selected="false">
                                            <span class="tab-span tab-span3">指導單位</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s3-tabs-4" class="
                                            nav-link
                                            nav-link4
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s3-tabs-4-tab" data-bs-toggle="pill" data-bs-target="#s3-tabs-4" role="tab"
                                            aria-controls="s3-tabs-4" aria-selected="false">
                                            <span class="tab-span tab-span4">注意事項</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="s3-tabs-tabContent">
                                    <div class="tabs-1 tab-pane fade show active flex flex-col" id="s3-tabs-1" role="tabpanel" aria-labelledby="s3-tabs-1-tab">
                                        <div class="intro">
                                            <h3 class="h3m">風浪板</h3>
                                            <p class="tm">【風帆隨筆_. 】讓我們放鬆一點,手酸了玩不下去我們也不在乎───希望你即使在海風吹拂的午後,能在海邊遊憩。
                                    ...
                                    <div class="tabs-2 tab-pane fade flex flex-col" id="s3-tabs-2" role="tabpanel" aria-labelledby="s3-tabs-2-tab">
                                        <div class="flex flex-col day1">
                                    ...
                                    <div class="tabs-3 tab-pane fade flex flex-col" id="s3-tabs-3" role="tabpanel" aria-labelledby="s3-tabs-3-tab">
                                        <div class="flex flex-col box">
                                            <h3 class="h3m">指導單位</h3>
                                            <p class="tm">主辦單位：台中市水中運動協會,SUP風浪板/獨木舟委員會</p>
                                            <p class="tm">協辦單位: 日月磐石水上活動中心</p>
                                    ...
                                    <div class="tabs-4 tab-pane fade flex flex-col" id="s3-tabs-4" role="tabpanel" aria-labelledby="s3-tabs-4-tab">
                                        <div class="flex flex-col box">
                                            <h3 class="h3m">注意事項</h3>
                                            <p class="tm">活動含保險、器材、救生衣，繳交後非本會或天然災害因素恕不退還。</p>
                                            <p class="tm">報名電話：水中運動協會報名專線 04-22312698 台中市總教練 詹寓崵 0930975535</p>
            ...
            <div class="w-full h-full s4-innerbox s-innerbox flex flex-col items-center">
                ...
                <div class="s4-innerbox-btm s-innerbox-btm w-4/5 flex flex-col">
                    ...
                    <div class="class-content w-full flex flex-row">
                        <div class="in-in-innerbox-right w-8/12 ">
                            <div class="banner w-full">
                                <div id="s4_mySwiper2" style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="/img/S__14082119.jpg" />
                                        </div>
                                    ...
                                    <div id="s4_swiper_button_prev" class="swiper-button-prev"></div>
                                    </div>
                            ...
                            <div class="tab w-full">
                                <ul class="nav nav-tabs flex flex-row flex-wrap list-none border-b-0 items-center" id="s4-tabs-tab"
                                    role="tablist">
                                    <li class="nav-item">
                                        <a href="#s4-tabs-1" class="
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s4-tabs-1-tab" data-bs-toggle="pill" data-bs-target="#s4-tabs-1" role="tab" aria-controls="s4-tabs-1"
                                        aria-selected="true">
                                        <span class="tab-span tab-span1">活動介紹</span>
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s4-tabs-2" class="
                                            nav-link
                                            nav-link1
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s4-tabs-2-tab" data-bs-toggle="pill" data-bs-target="#s4-tabs-2" role="tab"
                                            aria-controls="s4-tabs-2" aria-selected="false">
                                            <span class="tab-span tab-span2">課程流程</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s4-tabs-3" class="
                                            nav-link
                                            nav-link3
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s4-tabs-3-tab" data-bs-toggle="pill" data-bs-target="#s4-tabs-3" role="tab"
                                            aria-controls="s4-tabs-3" aria-selected="false">
                                            <span class="tab-span tab-span3">指導單位</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#s4-tabs-4" class="
                                            nav-link
                                            nav-link4
                                            block
                                            font-medium
                                            ...
                                            border-x-0 border-t-0 border-b-2 border-transparent
                                            focus:border-transparent
                                        " id="s4-tabs-4-tab" data-bs-toggle="pill" data-bs-target="#s4-tabs-4" role="tab"
                                            aria-controls="s4-tabs-4" aria-selected="false">
                                            <span class="tab-span tab-span4">注意事項</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="s4-tabs-tabContent">
                                    <div class="tabs-1 tab-pane fade show active flex flex-col" id="s4-tabs-1" role="tabpanel" aria-labelledby="s4-tabs-1-tab">
                                        <div class="intro">
                                            <h3 class="h3m">潛水</h3>
                                            <p class="tm">《休閒潛水》是在一種無重量的環境下，進入內太空，
                                                徹底放鬆全身心，讓一切都隨意而自然，在美麗的海底無言地觀賞五顏六色的奇異珊瑚和魚類，聽著自己的氣泡聲用手勢和眼神與同伴交流。
                                                這種感受是不可能在陸地上獲得的，也就是沒有真正潛入海底的人無法體會到的。</p>
                                        </div>
                                        <div class="purpor">
                                            <h3 class="h3m">活動主旨</h3>
                                            <p class="tm">SUP立式划槳教練課程，選修風浪板、獨木舟三合一Windsupyak板，
                                    ...
                                    <div class="tabs-2 tab-pane fade flex flex-col" id="s4-tabs-2" role="tabpanel" aria-labelledby="s4-tabs-2-tab">
                                        <div class="flex flex-col day1">
                                            <h3>第一天</h3>
                                            <div class="flex flex-col">
                                                <div class="flex day-time-title day-time">
                                    ...
                                    <div class="tabs-3 tab-pane fade flex flex-col" id="s4-tabs-3" role="tabpanel" aria-labelledby="s4-tabs-3-tab">
                                        <div class="flex flex-col box">
                                            <h3 class="h3m">指導單位</h3>
                                            <p class="tm">主辦單位：台中市水中運動協會,SUP風浪板/獨木舟委員會</p>
                                            <p class="tm">協辦單位: 日月磐石水上活動中心</p>
                                    ...
                                    <div class="tabs-4 tab-pane fade flex flex-col" id="s4-tabs-4" role="tabpanel" aria-labelledby="s4-tabs-4-tab">
                                        <div class="flex flex-col box">
                                            <h3 class="h3m">注意事項</h3>
                                            <p class="tm">活動含保險、器材、救生衣，繳交後非本會或天然災害因素恕不退還。</p>
                                            <p class="tm">報名電話：水中運動協會報名專線 04-22312698 台中市總教練 詹寓崵 0930975535</p>
            ...
            <div class="w-full h-full s5-innerbox s-innerbox flex flex-col items-center">
                ...
                <div class="s5-innerbox-btm s-innerbox-btm w-4/5 flex flex-col">
                            ...
                            <div class="class-content w-full flex flex-row">
                                <div class="in-in-innerbox-right w-8/12 ">
                                    <div class="banner w-full">
                                        <div id="s5_mySwiper2" style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img src="/img/S__14082119.jpg" />
                                                </div>
                                    ...
                                    <div class="tab w-full">
                                        <ul class="nav nav-tabs flex flex-row flex-wrap list-none border-b-0 items-center" id="s5-tabs-tab"
                                            role="tablist">
                                            <li class="nav-item">
                                                <a href="#s5-tabs-1" class="
                                                    nav-link
                                                    nav-link1
                                                    block
                                                    font-medium
                                            ...
                                            <li class="nav-item">
                                                <a href="#s5-tabs-2" class="
                                                    ...
                                                    border-x-0 border-t-0 border-b-2 border-transparent
                                                    focus:border-transparent
                                                " id="s5-tabs-2-tab" data-bs-toggle="pill" data-bs-target="#s5-tabs-2" role="tab"
                                                    aria-controls="s5-tabs-2" aria-selected="false">
                                                    <span class="tab-span tab-span2">課程流程</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#s5-tabs-3" class="
                                                    nav-link
                                                    nav-link3
                                                    block
                                                    font-medium
                                                    ...
                                                    border-x-0 border-t-0 border-b-2 border-transparent
                                                    focus:border-transparent
                                                " id="s5-tabs-3-tab" data-bs-toggle="pill" data-bs-target="#s5-tabs-3" role="tab"
                                                    aria-controls="s5-tabs-3" aria-selected="false">
                                                    <span class="tab-span tab-span3">指導單位</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#s5-tabs-4" class="
                                                    nav-link
                                                    nav-link4
                                                    block
                                                    font-medium
                                        ...
                                        <div class="tab-content" id="s5-tabs-tabContent">
                                            <div class="tabs-1 tab-pane fade show active flex flex-col" id="s5-tabs-1" role="tabpanel" aria-labelledby="s5-tabs-1-tab">
                                                <div class="intro">
                                            ...
                                            <div class="tabs-2 tab-pane fade flex flex-col" id="s5-tabs-2" role="tabpanel" aria-labelledby="s5-tabs-2-tab">
                                                <div class="flex flex-col day1">
                                                    <h3>第一天</h3>
                                                    <div class="flex flex-col">
                                                        <div class="flex day-time-title day-time">
                                            ...
                                            <div class="tabs-4 tab-pane fade flex flex-col" id="s5-tabs-4" role="tabpanel" aria-labelledby="s5-tabs-4-tab">
                                                <div class="flex flex-col box">
                                                    <h3 class="h3m">注意事項</h3>
                                                    <p class="tm">活動含保險、器材、救生衣，繳交後非本會或天然災害因素恕不退還。</p>
                                                    <p class="tm">報名電話：水中運動協會報名專線 04-22312698 台中市總教練 詹寓崵 0930975535</p>

...
<head>
    ...
    <link rel="stylesheet" href="/css/signUpStep3.css">
        ...
        <section class="container flex flex-col">
            ...
            <div class="content flex flex-col w-full">
                <div class="content-data ">
                    ...
                    <div class="data">
                        <div class="flex flex-col sm:flex-row w-full">
                            ...
                            <span class="tl w-full sm:w-1/2">陳拉拉</span>
                        </div>
                        <div class="flex flex-col sm:flex-row w-full">
                            <span class="tm w-full sm:w-1/2">身分證字號 (ID Numbers)</span>
                            <span class="tl w-full sm:w-1/2">M112233445</span>
                        </div>
                        <div class="flex flex-col sm:flex-row w-full">
                            <span class="tm w-full sm:w-1/2">性別</span>
                            <span class="tl w-full sm:w-1/2">男</span>
                        </div>
                        <div class="flex flex-col sm:flex-row w-full">
                            <span class="tm w-full sm:w-1/2">聯絡電話</span>
                            <span class="tl w-full sm:w-1/2">0912345678</span>
                        </div>
                        <div class="flex flex-col sm:flex-row w-full">
                            <span class="tm w-full sm:w-1/2">Email</span>
                            <span class="tl w-full sm:w-1/2">abc123@gamil.com</span>
                        </div>
                        <div class="flex flex-col sm:flex-row w-full">
                            <span class="tm w-full sm:w-1/2">通訊地址</span>
                            <span class="tl w-full sm:w-1/2">台中市南區中興大學1號</span>
                        </div>
                        <div class="flex flex-col sm:flex-row w-full">
                        ...
                        <div class="flex flex-col sm:flex-row w-full">
                            ...
                            <span class="tl w-full sm:w-1/2">陳媽媽</span>
                        </div>
                        <div class="flex flex-col sm:flex-row w-full">
                ...
                <div class="content-photo">
                    ...
                    <div class="idCard flex flex-col">
                        ...
                        <div class="box-idCard flex flex-col sm:flex-row">
                            <img class="img-idCard img-idCard1 h-full" src="/img/idCard1.png" alt="">
                            <img class="img-idCard h-full" src="/img/idCard2.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="innerbox-btn w-full flex justify-between">
                    ...
                    <button class="btn btn-next rounded flex justify-center items-center" type="submit"><a href="/signUpStep4.html">確認送出</a></button>
                </div>
            </div>
